...
namespace Facade.Logic.AccuWeather.LocationApi
{
    public interface ILocationService
    {
        ...
        /// <param name="offset">
        ///     Integer, along with the limit (25) that determines the first resource to be returned. If no offset
        ///     is provided, the max number (100) of results will be returned.
        /// </param>
        /// <param name="useAlias">
        ///     Enumeration that specifies when alias locations should be included in the results. By default, an
        ///     alias will only be returned if no official match for the search text was found. Enumeration values: Never or Always
        /// </param>
        ...
        IList<Location> GetLocations(string apikey, string q, string language, bool details, int offset,
            string useAlias);
    }
}