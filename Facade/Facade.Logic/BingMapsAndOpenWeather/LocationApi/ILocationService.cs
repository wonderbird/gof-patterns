...
namespace Facade.Logic.BingMapsAndOpenWeather.LocationApi
{
    public interface ILocationService
    {
        ...
        /// <param name="includeNeighbourhood">
        ///     One of the following values: 1: Include neighborhood information when available. 0
        ///     [default]: Do not include neighborhood information.
        /// </param>
        /// <param name="include">
        ///     One or more of the following options: queryParse: Specifies that the response shows how the query
        ///     string was parsed into address values, such as addressLine, locality, adminDistrict, and postalCode. ciso2:
        ///     Specifies to include the two-letter ISO country code. If you specify more than one include value, separate the
        ///     values with a comma. Examples: incl=queryParse incl=queryParse,ciso2
        /// </param>
        ...
        List<Resource> GetLocations(string query, string includeNeighbourhood, string include, int maxResults,
            string key);
    }
}